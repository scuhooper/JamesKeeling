...
NVMCClient.onInitialize = function () {
    ...
    NVMCClient.texture_facade.push(this.createTexture(gl,       NVMC.resource_path+'textures/rock.jpg'));
    NVMCClient.texture_facade.push(this.createTexture(gl,       NVMC.resource_path+'textures/future.jpg'));
    NVMCClient.texture_facade.push(this.createTexture(gl,       NVMC.resource_path+'textures/wood.jpg'));
