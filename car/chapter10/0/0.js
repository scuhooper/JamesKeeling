...
NVMCClient.onInitialize = function () {
    ...
    NVMCClient.texture_facade.push(this.createTexture(gl,       NVMC.resource_path+'textures/new_building1.jpg'));
    NVMCClient.texture_facade.push(this.createTexture(gl,       NVMC.resource_path+'textures/new_building2.jpg'));
    NVMCClient.texture_facade.push(this.createTexture(gl,       NVMC.resource_path+'textures/new_building3.jpg'));
