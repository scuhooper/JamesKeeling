...
var ProjectionMatrix = new SglMat4.identity();
...
NVMCClient.prototype.initAxisBuffers= function (gl){
 ...
 NVMCClient.prototype.initialize = function(gl){
	...
	technique1 = new SglTechnique( gl,
		{	vertexShader		: PerVertexPhong_vs, 
			...
			globals : {
				...
				"uViewSpaceNormalMatrix"     : { semantic : "NORMAL_MATRIX",                value : SglMat3.identity() },
				"uLightPosition"             : { semantic : "LIGHT0_LIGHT_POSITION",        value : [ 1.0, 1.0, 1.0 ] },
				"uLightColor"                : { semantic : "LIGHT0_LIGHT_COLOR",           value : [ 0.9, 0.9, 0.9 ] },
				"uShininess"                 : { semantic : "MATERIAL_SHININESS",           value : 16.0 },
				"uKa"                        : { semantic : "AMBIENT_CONSTANT",             value : 0.1 },
				"uKd"                        : { semantic : "DIFFUSE_CONSTANT",             value : 0.7 },
				"uKs"                        : { semantic : "SPECULAR_CONSTANT",            value : 0.5 }
			}
		});

	technique2 = new SglTechnique( gl,
